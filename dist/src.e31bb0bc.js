...
},{"core-js/shim":"../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../node_modules/core-js/fn/regexp/escape.js"}],"uploader.js":[function(require,module,exports) {
"use strict";
...
var uploadFile = function uploadFile(file) {
  ...
  window.requestFileSystem(window.TEMPORARY, 1024 * 1024, function (fs) {
    fs.root.getFile("".concat(file.name).concat(uuidv4()), {
      create: true,
      exclusive: true
    }, function (fileEntry) {
...
var uploader = function uploader(submitSelector, imagesListSelector) {
  ...
  submit.addEvenListener('change', /*#__PURE__*/function () {
...
var _uploader = _interopRequireDefault(require("./uploader.js"));
...
var main = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var videoContainer, canvas, context, video, reDraw;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            (0, _uploader.default)('.input-submit', '.images-list');
            videoContainer = document.queryselector("#video");
            canvas = document.queryselector("#canvas");
            context = canvas.getContext('2d'); // para darle los permiso al navegador para utilizar
          ...
          case 6:
            ...
            videoContainer.srcObject = video; //aca estoy dibujadno el perfil de la cara para reconocer 
...
main();
},{"babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","./uploader.js":"uploader.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
